...
example <- function(frag_num_string, x, y){
	png(paste("~/fragmented_genome_with_snps/arabidopsis_datasets/dataset5/figures/example_gradient_f", frag_num_string, ".png", sep=""))
	plot(x, y, main=paste("Example of gradient determination for fragment ", frag_num_string, " of dataset 5", sep=""), xlab="Fragment (bases)", ylab="SNP density")
