...
def adjacent_swaps_csv(dataset, size, pop_num, div, metric)
	# 1
...
def metric_test_plot(dataset, filename, metric, y_axis, title)
...
adjacent_swaps_csv(dataset, size, pop_num, div, metric)
metric_test_plot(dataset, 'adj_test', metric, metric, 'adjacent swaps')
