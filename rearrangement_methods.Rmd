...
barplot(scores, main="Comparison of Methods for Rearrangement of SNP Density Ordered Fragments, to The Original Sequenced Order", xlab="Methods", ylab="Ordinal Similarity Score", names.arg=methods)
