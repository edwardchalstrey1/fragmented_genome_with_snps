...
class TestModelGenome < Test::Unit::TestCase
	...
	def test_fasta_to_char_array
		assert_equal(%w(A T G C A T A A A A A), ModelGenome::fasta_to_char_array('unit_tests/test/dummy.fasta'))
	end
	...
	def test_vcf_array
		...
		assert_equal('frag1	2	.	T	A	100	PASS	AF=0.5', vcf_array[3])
		assert_equal('frag2	1	.	C	G	100	PASS	AF=1.0', vcf_array[4])
		assert_equal('frag3	3	.	C	G	100	PASS	AF=0.5', vcf_array[6])
	end
end